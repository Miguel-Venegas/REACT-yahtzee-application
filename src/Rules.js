...
const fourOfKind = new SumDistro({
  count: 4, description: ' If 4+ of one value, score sum of all dice (else 0)'});

// full house scores as flat 25
const fullHouse = new FullHouse({
  score: 25, description: 'If 3 of one value and 2 of another, score 25'});

// small/large straights score as 30/40
const smallStraight = new SmallStraight({
  score: 30, description: 'If 4+ values match, score 30' });
